...
class TokenJTW extends Model
{
     ...
     * Header - algorithm
     */
    public string $headerAlgorithm = 'HS256';

    /**
     * Header - token type
     */
    public string $headerTokenType = 'JWT';
    ...
    {
        return [
            'alg' => $this->headerAlgorithm,
            'typ' => $this->headerTokenType
        ];
    }
     ...
     * @return bool
     */
    public function is_jwt_valid($jtw_token): string
    {
        // split the jwt
     ...
     */
    public static function validate_jtw_token()
    {
